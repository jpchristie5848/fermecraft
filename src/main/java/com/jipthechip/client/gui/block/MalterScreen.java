...
public class MalterScreen extends InventoryScreenBase<MalterScreenHandler> implements ProcessorScreen<MalterBlockEntity>{
    ...
    public MalterScreen(MalterScreenHandler handler, PlayerInventory inventory, Text title) {
