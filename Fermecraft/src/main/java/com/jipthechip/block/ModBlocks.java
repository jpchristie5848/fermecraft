...
public class ModBlocks {
    ...
    public static void registerBlockEntities(){
        ...
        //registerBlockWithEntity(RegistryNames.FERMENTING_BARREL,
        //        new FermentingBarrelBlock(getBlockSettingsWithRegistryKey(AbstractBlock.Settings.copy(Blocks.BARREL).nonOpaque(), RegistryNames.FERMENTING_BARREL)),
        //        new BlockItem.Settings().maxCount(64), FermentingBarrelBlockEntity::new, FermentingBarrelBlockItem::new);
