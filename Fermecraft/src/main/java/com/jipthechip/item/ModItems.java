...
public class ModItems {
    ...
    public static Item MUG = new AlcoholContainerItem(getItemSettingsWithRegistryKey(new Item.Settings().maxCount(1), RegistryNames.MUG), 500);
    ...
    public static void registerItems(){
        ...
        ItemGroupEvents.modifyEntriesEvent(FERMECRAFT_ITEM_GROUP_KEY).register(entries -> {
            ...
            Beer beer = new Beer(5,500,20,40, BeerType.LAGER);
            ItemStack mugStack = new ItemStack(MUG);
            mugStack.set(DataComponentTypes.CUSTOM_MODEL_DATA, new CustomModelDataComponent(List.of(beer.getAbv(),beer.getAmount(),beer.getIbu(),beer.getSrm()), List.of(beer.getBeerType().ordinal() != 0), List.of("beer"), List.of(beer.getColor())));
